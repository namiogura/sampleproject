...
You can download the compendium as a zip from from this URL: <https://github.com/namiogura/sampleproject/archive/master.zip>

Or you can install this compendium as an R package, sampleproject, from GitHub with:
